...
export async function fetchStatsWithGemini(mandateId, recentTitles = []) {
    ...
    while (attempt < maxRetries) {
        try {
            ...
            if (attempt >= maxRetries) {
                log('WARNING [Gemini-Stats]', 'Failed to fetch stats from Gemini after all retries. Returning empty array.');
                return [];
            }
