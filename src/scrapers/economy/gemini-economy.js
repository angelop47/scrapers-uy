...
export async function fetchEconomicIndicators(previousState) {
    ...
    while (attempt < maxRetries) {
        try {
            ...
            if (attempt >= maxRetries) {
                log('WARNING [Gemini-Economy]', 'Failed to fetch economy stats from Gemini after all retries. Returning nulls.');
